        ...
        <div id="sidebar-scrollbar">
            <nav class="iq-sidebar-menu">
                <ul id="iq-sidebar-toggle" class="iq-menu">
                    ...
                    <li><a href="{{ route('admin.testimonies.index') }}" class="iq-waves-effect">
                            <i class="las la-money iq-arrow-left"></i><span>Manage Testimonies</span></a></li>
            ...
            <nav class="navbar navbar-expand-lg navbar-light p-0">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto navbar-list">
                        ...
                        <li><a style="font-size: 12px; margin-top: 20px;" href="{{ route('admin.testimonies.index') }}"><span>Manage Testimonies</span></a></li>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6 text-right">
                    Copyright {{ date('Y') }} <a href="">Apex Digital Chain</a> All Rights Reserved.
                </div>
            </div>
        </div>
    </footer>
