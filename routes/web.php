...
Route::get('investment-plans', 'HomeController@investmentPackages');
...
Route::get('admin/testimonies/index', [AdminTestimonyController::class, 'index'])
    ->name('admin.testimonies.index');
Route::get('admin/testimony/create', [AdminTestimonyController::class, 'create'])
    ->name('admin.testimony.create');
Route::post('admin/testimony/store', [AdminTestimonyController::class, 'store'])
    ->name('admin.testimony.store');
Route::get('admin/testimony/{id}/edit', [AdminTestimonyController::class, 'edit'])
    ->name('admin.testimony.edit');
Route::put('admin/testimony/{id}/update', [AdminTestimonyController::class, 'update'])
    ->name('admin.testimony.update');
Route::delete('admin/testimony/{id}/delete', [AdminTestimonyController::class, 'delete'])
    ->name('admin.testimony.delete');
